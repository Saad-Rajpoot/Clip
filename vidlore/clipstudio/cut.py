...
def cut_selection(proj: ClipProject, sel: ClipSelection, cfg: ClipConfig) -> Optional[Path]:
...
def cut_all(proj: ClipProject, cfg: ClipConfig, *, workers: Optional[int] = None, progress=None) -> int:
